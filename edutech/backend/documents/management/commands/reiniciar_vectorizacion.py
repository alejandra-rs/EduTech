...
class Command(BaseCommand):
    help = 'Limpia la base de datos vectorial por completo y resetea el estado de los PDFs'

    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.WARNING("Iniciando protocolo de limpieza extrema... 🧹"))
        ...
        try:
            ...
            with engine.connect() as conn:
                ...
                conn.commit()
            self.stdout.write(self.style.SUCCESS("  -> ✓ Base de datos PGVector limpia."))
        ...
        total_actualizados = PDFAttachment.objects.all().update(processing_status='pendiente')
        
        self.stdout.write(self.style.SUCCESS(f"  -> ✓ {total_actualizados} PDFs marcados como 'pendientes'."))
