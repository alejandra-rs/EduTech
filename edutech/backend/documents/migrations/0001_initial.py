...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        upload_to="documents/",
                        validators=[
                            documents.models.attachments.validate_pdf_extension,
                            documents.models.attachments.validate_pdf_size,
                        ],
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="post",
            index=models.Index(
                fields=["course", "post_type", "-created_at"],
                name="documents_p_course__38c931_idx",
            ),
        ),
        ...
        migrations.AddConstraint(
            model_name="dislike",
            constraint=models.UniqueConstraint(
                fields=("post", "user"), name="unique_dislike"
            ),
        ),
        migrations.AddIndex(
            model_name="comment",
            index=models.Index(
                fields=["post", "-created_at"], name="documents_c_post_id_308b24_idx"
            ),
        ),
    ]
