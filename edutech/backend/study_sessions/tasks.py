...
def connect_to_twitch_eventsub(
    self,
    study_session_id: int,
    broadcaster_twitch_id: str,
    access_token: str,
    twitch_user_id: str,
):
    asyncio.run(
        _listen(study_session_id, broadcaster_twitch_id, access_token, twitch_user_id)
    )
    ...
    async with websockets.connect("wss://eventsub.wss.twitch.tv/ws") as ws:
        async for raw in ws:
            ...
            if msg_type == "session_welcome":
                ...
                await _create_eventsub_subscription(
                    twitch_session_id,
...
async def _create_eventsub_subscription(
    twitch_session_id: str,
    broadcaster_twitch_id: str,
    access_token: str,
    twitch_user_id: str,
) -> None:
