...
urlpatterns = [
    path(
        "<int:pk>/", views.StudySessionDetailView.as_view(), name="study_session_detail"
    ),
    path(
        "<int:pk>/star/",
    ...
    path(
        "twitch/callback/", views.TwitchCallbackView.as_view(), name="twitch_callback"
    ),
    path("twitch/status/", views.TwitchStatusView.as_view(), name="twitch_status"),
    path(
        "<int:pk>/chat/",
        views.TwitchSendMessageView.as_view(),
        name="study_session_chat",
    ),
