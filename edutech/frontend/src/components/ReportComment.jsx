...
export default function ReportComment() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Reporte de comentario enviado");
    setIsReported(true);
    setIsOpen(false);
  };
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Reportar comentario</h3>
                <button 
                    onClick={handleClose} 
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    placeholder="Explica por qué este comentario infringe las normas..." 
                    rows={5} 
                    />
