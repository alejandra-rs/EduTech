...
const CompletionBanner = ({ variant = "flashcard", stats, onRestart }: CompletionBannerProps) => {
  return (
    <div className="mt-16 p-10 bg-gray-900 rounded-[2.5rem] text-center text-white animate-in zoom-in duration-500">
      <h2 className="text-2xl font-semibold mb-2">{(variant === "flashcard") ? "Flashcards Completadas" : "Cuestionario Completado"}</h2>
