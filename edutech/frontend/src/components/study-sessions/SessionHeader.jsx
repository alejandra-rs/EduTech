...
export function SessionHeader({ session, currentUserId, isStarred, onStarChange }) {
      ...
      <div className="space-y-6 w-full">
        ...
        <div className="flex w-full text-sm justify-between items-center">
          ...
          <div className="flex items-center gap-2 text-gray-600 font-medium">
            {session.creator.profile_picture && (
              <img src={session.creator.profile_picture} alt={session.creator.first_name} className="w-5 h-5 rounded-full object-cover" />
            )}
