...
export const CreateSessionModal = ({ setIsModalOpen, currentUser, handleCreateSession, newSession, setNewSession, subjects }) => (
    ...
    <div className="relative bg-white w-full max-w-lg rounded-[32px] shadow-2xl p-8 animate-in fade-in zoom-in duration-200 overflow-y-auto max-h-[90vh]">
      ...
      <form onSubmit={handleCreateSession} className="space-y-4">
        <SubjectDropdown
          ...
          onChange={(v) => setNewSession({ ...newSession, courseId: v })}
          subjects={subjects}
