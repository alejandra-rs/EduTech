...
import type { ReportSubmitData } from './ReportPopup';
...
export default function ReportButton({ entity = "Publicación", postId, onSubmit }: ReportButtonProps) {
  ...
  return (
    <>
      ...
      <ReportPopup
        ...
        onClose={handleClose}
        entity={entity}
        onSubmit={onSubmit ?? (async () => { setIsReported(true); })}
      />
    </>
  );
}
